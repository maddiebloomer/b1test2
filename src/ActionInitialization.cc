...
//So action initialization's job is just to be in charge of all of the processes which happen beyond the setup?
...
void ActionInitialization::Build() const
{
  ...
  SetUserAction(new TrackingAction(fRunAction));
}
